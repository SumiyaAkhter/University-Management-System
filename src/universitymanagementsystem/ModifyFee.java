...
int id=0;
private void btnsearchActionPerformed(java.awt.event.ActionEvent vevt){
    String query="select * from fee where admission='"+txtsadm.getText()+"'and yr='"+cbsyear.getSelectedItem()+"'and month='"+cbsmonth.getSelectedItem()+"'";
    ...
    try
    {
        if(rs.next)
        {
            ...
            admissionno=rs.getInt("admissionno");
        }
        else
        {
...
private void btnupdateActionPerformed(java.awt.event.ActionEvent evt){
    String query="update fee set yr='"+cbyear.getSelectedItem()+"',month='"+cbmonth.getSelectedItem()+"',amount='"+txtamount.getText()+"'where admissionno="+id+"";
    sd.update(query);
    admissionno=0;
    this.dispose();
}
private void btndeleteActionPerformed(java.awt.event.ActionEvent evt){
    String query="delete from fee where admissionno="+admissionno+"";
    sd.delete(query);
    admissionno=0;
    this.dispose();
